...
}" class="mt-8 p-4 border-t border-b" style="margin-top: 2rem; border-color: gray;">
    <button class="my-button flex gap-2" style="gap:0.5rem;" @click="clap()">
        ...
        <template x-if="hasClapped">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="size-6" width="24" height="24">
                <path
